    ...
    return (
        <footer className= "text-primary border-t-2">
            <div className="mx-auto max-w-7xl space-y-8 px-4 py-10 sm:px-6 lg:space-y-16 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div>
                        <Link className="flex items-center" href="/">
                            <Logo />
                            <h3 className="text-xl md:text-lg lg:text-xl text-primary font-bold">Asia Transport</h3>
                        </Link>

                        <p className="mt-4 max-w-xs text-muted-foreground">
                            We are a reliable courier service committed to fast, safe, and timely delivery across all destinations. Your parcels are handled with care and delivered with trust.
                        </p>
                ...
                {/* Copyright */}
                <p className="text-xs text-gray-500">© 2026 Asia Transport. All rights reserved.</p>
            </div>
        </footer>
